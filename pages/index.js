...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-all duration-300 ease-in-out ${theme === "dark" ? "dark" : "light"}`}>
      <div className="flex flex-col flex-grow">
        ...
        <div className="py-8 mt-4 flex justify-center mx-auto dark:text-white text-center flex-grow">
          <div className="text-center mt-20 p-5 px-4 sm:px-8 md:px-12">
        ...
        <div className="py-6 px-4 translate-y-5 flex-grow">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 justify-center text-center">
