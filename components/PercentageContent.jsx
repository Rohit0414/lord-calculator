const PercentageContent = () => {
    return (
        <div className="p-6 max-w-screen-lg mx-auto bg-white text-gray-800 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="bg-blue-50 dark:bg-blue-800 p-4 rounded-lg mb-6">
                <p className="font-semibold">CGPA = Percentage / Multiplication Factor</p>
                ...
                <p className="text-blue-600 font-bold mt-2">CGPA = 92.4 / 9.5 = 9.72</p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-800 p-4 rounded-lg mb-6">
                ...
                <p className="text-blue-600 font-bold mt-2">CGPA = (Sum of all SGPA values) / Number of semesters</p>
                <p className="italic mt-2">
                    Example: Ram achieved SGPA values of 6, 8.5, 7, and 9.5 in 4 semesters. His CGPA would be:
                </p>
                <p className="text-blue-600 font-bold mt-2">CGPA = (6 + 8.5 + 7 + 9.5) / 4 = 7.75</p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-800 p-4 rounded-lg mb-6">
                ...
                <p className="text-blue-600 font-bold mt-2">CGPA = (Sum of SGPA * Credits) / Total Credits</p>
                <p className="italic mt-2">
                    Example: Shyam achieved SGPA values of 7.2, 6.5, 8.9, and 9.6 with corresponding credits of 4, 3, 3, and 5. His CGPA would be:
                </p>
                <p className="text-blue-600 font-bold mt-2">CGPA = (7.2 * 4 + 6.5 * 3 + 8.9 * 3 + 9.6 * 5) / (4 + 3 + 3 + 5) = 8.2</p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-800 p-4 rounded-lg mb-6">
                ...
                <p className="text-blue-600 font-bold mt-2">Percentage = (Sum of Marks / Total Marks) * 100</p>
                <p className="italic mt-2">
                ...
                <p className="text-blue-600 font-bold mt-2">Percentage = (295 + 265 + 273 + 264) / 1200 * 100 = 91.41%</p>
            </div>
